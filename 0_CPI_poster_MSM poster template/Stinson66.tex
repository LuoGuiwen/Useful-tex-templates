...
\usepackage{caption} % No caption number for figures and tables
...
\title{On the Optimization of Pippenger's Bucket Method with Precomputation} % Poster title
...
\newblock {\em preprint, Mar}, 27, 1995.
\end{thebibliography}
